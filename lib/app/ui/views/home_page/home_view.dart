      ...
      child: Scaffold(
        ...
        body: BlocBuilder<HomeCubit, List<Foods>>(
          builder: (context, foodList) {
            // İlk yükleme için foods'ları yükle
            if (foodList.isEmpty) {
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return GestureDetector(
                                ...
                                child: FoodCardWidget(
                                  ...
                                  onFavoriteChanged: () {
                                    // HomeView'da favori değiştiğinde sayfayı yenile
                                    setState(() {});
                                  },
                                ),
                              );
  ...
  DropdownMenu<String> _dropDownMenu(
    ...
    return DropdownMenu(
        menuStyle: MenuStyle(backgroundColor: WidgetStateProperty.resolveWith((
          ...
          return AppColorConstants.whiteColor;
        })),
        trailingIcon: Icon(Icons.filter_list_rounded),
        inputDecorationTheme: InputDecorationTheme(suffixIconColor: AppColorConstants.whiteColor),
        width: mWidth * 0.3,
